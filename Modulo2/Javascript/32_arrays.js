...
const numerosbus = [10, 20, 30, 20, 40];

// indexOf — primera posición del valor, -1 si no existe
console.log(numerosbus.indexOf(20));    // 1
console.log(numerosbus.indexOf(99));    // -1

// lastIndexOf — última posición del valor
console.log(numerosbus.lastIndexOf(20));  // 3

// includes — ¿existe el valor? devuelve boolean
console.log(numerosbus.includes(30));   // true
console.log(numerosbus.includes(99));   // false



const frutasEach = ["manzana", "banana", "cereza"];

// forEach no devuelve nada (undefined)
frutasEach.forEach((fruta, indice) => {
