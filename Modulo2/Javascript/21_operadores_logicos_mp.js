...
console.log(Boolean(0));        // false
console.log(Boolean(""));       // false
console.log(Boolean("Quito"));  // true
console.log(Boolean([]));       // true  ← array de propiedades vacío es truthy
...
// Cortocircuito — devuelve el primer valor falsy o el último si todos son truthy
console.log(120000 && 150000);    // 150000 ← ambos truthy, devuelve el último
console.log(0 && 150000);         // 0      ← 0 es falsy, se detiene y devuelve 0
console.log("" && "Sector");      // ""     ← "" es falsy, se detiene
console.log("Casa" && "Suite");   // "Suite" ← ambos truthy, devuelve el último

// Uso práctico: ejecutar algo solo si una condición se cumple
const inmueble = { tipo: "Departamento", destacado: true };

inmueble.destacado && console.log("Mostrar etiqueta de oferta");
// equivale a: if (inmueble.destacado) { console.log(...) }

// Acceso seguro a propiedades anidadas
const garaje = inmueble.detalles && inmueble.detalles.parqueaderos;
// Si inmueble.detalles no existe (falsy), garaje = undefined (no lanza error)
