const productos=[
    {
        "id":1,
        "nombre":"Casa en Cumbayá",
        "descripcion":"Casa de 3 dormitorios con jardín",
        "precio":185000
    },
    {
        "id":2,
        "nombre":"Departamento en La Carolina",
        "descripcion":"Departamento de 2 dormitorios, amoblado",
        "precio":135000
    },
    {
        "id":3,
        "nombre":"Terreno en Tumbaco",
        "descripcion":"Terreno de 500 m2, listo para construir",
        "precio":45000
    },
...
function editarProducto(id){
    ...
    if (producto){
        ...
        idEditar = id;
        agregarBtn.textContent = 'Actualizar Propiedad';
...
function actualizarProducto(){
    ...
    const productoIndex = productos.findIndex(p => p.id === idEditar);
        if(productoIndex !== -1){
            ...
            renderProductos();
            limpiarFormulario();
            agregarBtn.textContent = 'AGregar Propiedad';
